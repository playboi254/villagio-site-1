      ...
      <div className="bg-primary text-primary-foreground">
        <div className="container flex h-16 items-center justify-between gap-4">
          ...
          <Link to="/" className="flex items-center gap-2 shrink-0">
            ...
            <span className="hidden sm:inline text-sm font-medium opacity-80">Farm Fresh</span>
          </Link>
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center gap-2 text-primary-foreground hover:bg-primary-foreground/10">
                  <Avatar className="h-8 w-8">
                    ...
                    <AvatarFallback className="bg-accent text-accent-foreground">BO</AvatarFallback>
                  </Avatar>
                  <span className="hidden sm:inline font-medium">Barrack</span>
                </Button>
              </DropdownMenuTrigger>
