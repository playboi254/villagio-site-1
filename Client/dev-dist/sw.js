...
define(['./workbox-438b26d2'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^http:\/\/localhost:8000\/uploads\//, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/\/assets\/.*\.(jpg|jpeg|png|webp)$/, new workbox.CacheFirst({
